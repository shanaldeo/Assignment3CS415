...
                                </div>
                                ...
                                {{-- NEW SECTION FOR THE TRANSCRIPT BUTTON --}}
                                <div class="p-3 mb-3 border rounded bg-white text-center">
                                    <h5>Actions</h5>
                                    <a href="{{ route('student.transcript.download', ['studentId' => $student->id]) }}"
                                       class="btn btn-primary mt-3"
                                       target="_blank"
                                       title="Download Academic Transcript">
                                        <i class="bi bi-file-earmark-pdf"></i> Download Academic Transcript
                                    </a>
